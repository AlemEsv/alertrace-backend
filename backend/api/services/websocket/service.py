...
class WebSocketManager:
    ...
    async def connect(self, websocket: WebSocket):
        ...
        logger.info(
            f"Cliente WebSocket conectado. Total conexiones: {len(self.active_connections)}"
        )
    ...
    def disconnect(self, websocket: WebSocket):
        ...
        if websocket in self.active_connections:
            ...
            logger.info(
                f"Cliente WebSocket desconectado. Total conexiones: {len(self.active_connections)}"
            )
