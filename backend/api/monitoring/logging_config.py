...
def setup_logging(app_name: str = "sachatrace", log_level: str = "INFO") -> logging.Logger:
    """
...
def log_request(path: str, method: str, status_code: int, duration_ms: float, user_id: str = None):
    """Log HTTP request"""
