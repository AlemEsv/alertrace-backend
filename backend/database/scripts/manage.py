...
class DatabaseManager:
    ...
    def show_data_summary(self):
        ...
        try:
            ...
            print(
                f"Harvest Events: {harvest_events}, Processing Events: {processing_events}"
            )
            print(
                f"Transfer Events: {transfer_events}, Blockchain Syncs: {blockchain_syncs}"
            )
        finally:
            db.close()
